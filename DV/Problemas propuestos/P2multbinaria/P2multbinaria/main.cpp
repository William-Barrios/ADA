...
int main(int argc, const char * argv[]) {
        std::string binario1 = "11";  // Reemplaza con el primer número binario
        std::string binario2 = "10";  // Reemplaza con el segundo número binario

        std::bitset<32> bits1(binario1);
        std::bitset<32> bits2(binario2);
        ...
        std::string resultadoBinario = resultBits.to_string();

        std::cout << "Resultado de la multiplicación: " << resultadoBinario << std::endl;
